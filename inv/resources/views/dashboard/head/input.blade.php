...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-lg mx-auto">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-gray-700 font-bold text-xl">Input Data Kepala Unit</h2>
            <a href="/kepala-unit" class="bg-gray-500 text-white px-4 py-2 rounded-md text-sm hover:bg-gray-600 transition">Kembali</a>
        </div>

        <form action="/input-kepala" method="POST" class="space-y-4">
            @csrf
            <div>
                <label class="text-sm text-gray-700" for="name">Nama Kepala</label>
            ...
            <div>
                <label class="text-sm text-gray-700" for="email">Email Kepala</label>
