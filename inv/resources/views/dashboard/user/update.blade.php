...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-lg mx-auto">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-gray-700 font-bold text-xl">Edit User</h2>
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input id="name" name="name" type="text" value="{{ old('name', $user->name) }}" autocomplete="off"
            ...
            <div>
                ...
                <input id="email" name="email" type="email" value="{{ old('email', $user->email) }}" autocomplete="off"
            ...
            <div>
                <label for="password" class="text-sm text-gray-700">Password <span class="text-xs text-gray-500">(leave blank if not changing)</span></label>
            ...
            <div>
                <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 transition">Update User</button>
            </div>
        </form>
    </div>
</div>
