...
<body class="bg-gray-100 text-black">
    ...
    <div class="w-64 bg-gray-900 h-screen p-5 fixed top-0 left-0 shadow-lg">
        ...
        <ul class="mt-6 space-y-3">
            ...
            <!-- logic baru -->
            <li><a href="{{ route('supplies.index') }}" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 rounded-md transition"><i class="ri-archive-line mr-3 text-lg"></i> Aktivitas Stok</a></li>
